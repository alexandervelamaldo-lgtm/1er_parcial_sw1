...
| 5 | [Guía de voz y OCR](05-guia-voz-y-ocr.md) | Uso paso a paso de las dos funcionalidades, importación y exportación en XMI, módulos y subpaquetes, el diagrama de comunicación del backend generado, configuración de la clave, seguridad, límites conocidos del OCR |
