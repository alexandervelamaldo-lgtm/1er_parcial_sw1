...
> **Estado:** implementada y en verde (1055 pruebas, 43 ficheros). La arquitectura y las guías de uso están en [`docs/`](docs/README.md). El backend generado ya se ha compilado y arrancado de verdad; lo que sigue sin verificar —imagen Docker, RDS— está enumerado sin adornos en [Despliegue §6.6](docs/06-despliegue.md#66-estado) y [§5.12](docs/05-guia-voz-y-ocr.md#512-pruebas).
